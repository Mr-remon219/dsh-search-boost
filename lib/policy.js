...
//
// v3 (2026-08): added the hard rule "doubt → search". Any uncertainty about
// an external fact (fuzzy memory, stale suspicion, unsure source, unsure
// number) MUST trigger an immediate search; you may not dissolve doubt by
// reasoning or guessing. An answer that still contains doubt is a failed
// answer.
