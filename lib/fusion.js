...
//   - TIER_ENGINES_FREE   (free layer): keyless engines only — agy / bing /
//                          ddg / exa-free. No keys, no credit burn.
// The active layer stops keyed engines from ever being dialed in free mode.
export const TIER_ENGINES = {
  simple: ['bing', 'ddg', 'exa-free'],
  medium: ['bing', 'ddg', 'exa-free', 'antigravity', 'tavily'],
  complex: ['bing', 'ddg', 'exa-free', 'antigravity', 'tavily', 'brave', 'exa'],
}
export const TIER_ENGINES_FREE = {
  simple: ['bing', 'ddg', 'exa-free'],
  medium: ['bing', 'ddg', 'exa-free', 'antigravity'],
  complex: ['bing', 'ddg', 'exa-free', 'antigravity'],
}
...
const ENGINE_WEIGHT = { bing: 1.0, ddg: 1.0, antigravity: 1.0, 'exa-free': 1.1, tavily: 1.2, exa: 1.2, brave: 1.1 }
...
export const SECONDARY_VARIANTS = {
  free: ['bing', 'ddg', 'exa-free'],
  api: ['bing', 'ddg', 'exa-free', 'tavily'],
}
