...
if ($node) {
  ...
  foreach ($f in @("index.js", "lib\engines.js", "lib\exa-free.js", "lib\layer.js", "lib\fusion.js", "lib\fetch.js", "lib\xauth.js", "lib\xsearch.js", "lib\xfallback.js", "lib\policy.js")) {
